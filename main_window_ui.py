...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnPrevStep = QPushButton(self.frameBottom)
        self.btnPrevStep.setObjectName(u"btnPrevStep")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnPrevStep.setText(QCoreApplication.translate("MainWindow", u"< Anterior", None))
        self.btnNextStep.setText(QCoreApplication.translate("MainWindow", u"Siguiente >", None))
